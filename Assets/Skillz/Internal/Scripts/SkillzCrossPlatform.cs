...
public static class SkillzCrossPlatform
{
  ...
  internal static void InitializeSimulatedMatch(string matchInfoJson, int randomSeed)
  {
    ...
    {
      SkillzDebug.LogWarning(SkillzDebug.Type.SKILLZ, $"Expected an SkillzSDK.Internal.API.UnityEditor.BridgedAPI instance for initializing a simulated match!");
      return;
    }

    editorBridgedApi.InitializeSimulatedMatch(matchInfoJson, randomSeed);
  }
